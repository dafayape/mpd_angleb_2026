...
class KeynoteController extends Controller
{
    public function index()
    {
        $requirements = [
            ...
            ['no' => 13, 'content' => 'Persandingan pergerakan harian total berdasarkan masing-masing opsel', 'group' => 'Pergerakan Nasional', 'route' => 'pages.nasional.pergerakan-harian'],
            ['no' => 14, 'content' => 'Akumulasi pergerakan harian dari seluruh opsel dan keterangan singkat terkait jumlah unique subscribernya', 'group' => 'Pergerakan Nasional', 'route' => 'pages.nasional.pergerakan-harian'],
            ['no' => 15, 'content' => 'Pergerakan harian total (Pergerakan per hari dan orang per hari) + Tabel rincian jumlah pergerakan dan orang per hari', 'group' => 'Pergerakan Nasional', 'route' => 'pages.nasional.pergerakan-harian'],
            ...
            ['no' => 22, 'content' => 'Persandingan pergerakan harian total berdasarkan masing-masing opsel (Intra Jabodetabek)', 'group' => 'Pergerakan Jabodetabek', 'route' => 'pages.jabodetabek.intra-pergerakan'],
            ['no' => 23, 'content' => 'Akumulasi pergerakan harian dari seluruh opsel dan keterangan singkat terkait jumlah unique subscribernya (Intra Jabodetabek)', 'group' => 'Pergerakan Jabodetabek', 'route' => 'pages.jabodetabek.intra-pergerakan'],
            ['no' => 24, 'content' => 'Pergerakan harian total (pergerakan per hari dan orang per hari) untuk Intra Jabodetabek', 'group' => 'Pergerakan Jabodetabek', 'route' => 'pages.jabodetabek.intra-pergerakan'],
            ['no' => 25, 'content' => 'Akumulasi pergerakan harian total berdasarkan masing-masing opsel (Intra Jabodetabek)', 'group' => 'Pergerakan Jabodetabek', 'route' => 'pages.jabodetabek.intra-pergerakan'],
            ['no' => 26, 'content' => 'Persandingan pergerakan harian total berdasarkan masing-masing opsel (Inter Jabodetabek)', 'group' => 'Pergerakan Jabodetabek', 'route' => 'pages.jabodetabek.inter-pergerakan'],
            ...
            ['no' => 34, 'content' => 'Kesimpulan Jabodetabek', 'group' => 'Kesimpulan dan Rekomendasi', 'route' => 'pages.kesimpulan.jabodetabek'],
            ['no' => 35, 'content' => 'Rekomendasi', 'group' => 'Kesimpulan dan Rekomendasi', 'route' => 'pages.kesimpulan.rekomendasi'],
            ...
            ['no' => 36, 'content' => 'Simpul Transportasi Terpadat — Stasiun KA regional asal dan tujuan terpadat (Angkutan Kereta Api Perkotaan)', 'group' => 'Substansi Tambahan', 'route' => 'pages.substansi.stasiun-ka-regional'],
            ['no' => 36, 'content' => 'Simpul Transportasi Terpadat — Stasiun KA cepat asal dan tujuan terpadat (Angkutan Kereta Api KCJB)', 'group' => 'Substansi Tambahan', 'route' => 'pages.substansi.stasiun-ka-cepat'],
            ...
            ['no' => 36, 'content' => 'Simpul Transportasi Terpadat — Terminal asal dan tujuan terpadat', 'group' => 'Substansi Tambahan', 'route' => 'pages.substansi.terminal'],
            ['no' => 36, 'content' => 'Simpul Transportasi Terpadat — O-D simpul pelabuhan', 'group' => 'Substansi Tambahan', 'route' => 'pages.substansi.od-simpul-pelabuhan'],
            ['no' => 37, 'content' => 'Netflow Pergerakan', 'group' => 'Substansi Tambahan', 'route' => 'pages.substansi.netflow'],
        ];
