...
class CitySeeder extends Seeder
{
    public function run(): void
    {
        $cityDataVector = [
            ...
            ['9271', 'KOTA SORONG'],
            ['9301', 'KAB. MERAUKE'],
            ['9302', 'KAB. BOVEN DIGOEL'],
            ['9303', 'KAB. MAPPI'],
            ['9304', 'KAB. ASMAT'],
            ['9401', 'KAB. NABIRE'],
            ['9402', 'KAB. PUNCAK JAYA'],
            ['9403', 'KAB. PANIAI'],
            ['9404', 'KAB. MIMIKA'],
            ['9405', 'KAB. PUNCAK'],
            ['9406', 'KAB. DOGIYAI'],
        ...
        foreach (array_chunk($cityDataVector, $chunkSize) as $chunk) {
            $mappedChunk = [];
            foreach ($chunk as $vector) {
                $code = $vector[0];
                $name = $vector[1];
