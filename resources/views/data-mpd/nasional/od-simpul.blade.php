    ...
    @section('content')
        @component('layout.partials.page-header', ['number' => '05', 'title' => $title])
            ...
            <div class="col-12">
                <div class="card content-card w-100 flex-column">
                    <div class="card-header d-flex align-items-center bg-white"
                        ...
                        <h5 class="fw-bold text-navy mb-0">O-D Provinsi Asal (10 besar provinsi asal favorit Nasional) &
                            Desire
                            line</h5>
                                ...
                                <div class="rounded p-4 d-flex align-items-center justify-content-center text-center"
                                    ...
                                    @if (count($top_origin) > 0)
                                        <span class="text-navy fw-medium" style="font-size: 1.05rem; line-height:1.5;">
                                            Pada periode
                                            <strong>{{ \Carbon\Carbon::parse(config('mpd.start_date', '2026-03-13'))->translatedFormat('d F Y') }}
                                                s/d
                                                {{ \Carbon\Carbon::parse(config('mpd.end_date', '2026-03-29'))->translatedFormat('d F Y') }}</strong>,
                                            <strong style="font-size:1.15rem; color:#1e3a8a;">Provinsi
                                                {{ ucwords(strtolower($top_origin[0]['name'])) }}</strong> merupakan
                                            Provinsi
            ...
            <div class="col-12">
                <div class="card content-card w-100 flex-column">
                    <div class="card-header d-flex align-items-center bg-white"
                        ...
                        <h5 class="fw-bold text-navy mb-0">Top 30 Kab/Kota (30 besar kab/kota asal dan tujuan favorit
                            Nasional)
                        </h5>
                        <div class="export-dropdown ms-auto">
                    ...
                    <div class="card-body bg-white" id="section-od03-content" style="padding: 2.5rem 1.5rem;">
                        ...
                        <div class="row align-items-stretch">
                            ...
                            <div class="col-xl-6 col-lg-12 mb-4 mb-xl-0 d-flex flex-column">
                                <div class="border rounded p-3 flex-grow-1"
                                    style="border-width:2px !important; border-color: #aab5c3 !important;">
                                    <h5 class="text-center fw-bold text-primary mb-3 mt-2" style="font-size: 1.25rem;">Top
                            ...
                            <div class="col-xl-6 col-lg-12 d-flex flex-column">
                                <div class="border rounded p-3 mb-4 flex-grow-1"
                                    style="border-width:2px !important; border-color: #aab5c3 !important;">
                                    <h5 class="text-center fw-bold text-primary mb-3 mt-2" style="font-size: 1.25rem;">30
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-custom mb-0 text-center">
                                            ...
                                            <tbody>
                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="6" class="text-center py-3 text-muted">Belum ada
                                                            data
                                                        </td>
                                                    </tr>
                                                @endif
