                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mb-5">
                        <table class="table table-bordered table-striped table-hover table-sm w-100 mb-0"
                            ...
                            <thead class="table-info text-dark text-center align-middle sticky-top"
                                style="top: 0; z-index: 1;">
                                <tr>
                                    <th rowspan="2" class="shadow-sm" style="min-width: 180px; width: 200px;">Moda
                                        Transportasi</th>
                                ...
                                <tr>
                                    @foreach ($dates as $date)
                                        <th style="min-width: 65px; width: 65px; border-bottom: 2px solid #ccc;">
                            ...
                            <tfoot class="table-light fw-bold text-end">
                                <tr>
                                    ...
                                    @foreach ($dates as $date)
                                        <td class="text-end">
                                            @php
                                                $dailyTotal = collect($movementMatrix)->sum(
                                                    fn($row) => $row[$date] ?? 0,
                                                );
                                            @endphp
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover table-sm w-100 mb-0"
                            style="border-collapse: collapse; border-spacing: 0; font-size: 11px;">
                            <thead class="table-success text-dark text-center align-middle sticky-top"
                                style="top: 0; z-index: 1;">
                                <tr>
                                    <th rowspan="2" class="shadow-sm" style="min-width: 180px; width: 200px;">Moda
                                        Transportasi</th>
