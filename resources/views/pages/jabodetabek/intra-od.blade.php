...
@section('content')
    @component('layout.partials.page-header', ['number' => '07', 'title' => $title])
    ...
    <!-- 01 O-D KOTA AAL JABODETABEK & DESIRE LINE -->
                ...
                <div class="card-body bg-white" style="padding: 2.5rem 1.5rem;">
                    ...
                    <div class="row align-items-stretch">
                        ...
                        <div class="col-xl-5 col-lg-12 d-flex flex-column">
                            <h5 class="fw-bold text-navy mb-3 mt-2" style="font-size: 1.25rem;">Kota/Kab Asal Favorit
                                Jabodetabek</h5>
                            <div class="border rounded p-0 mb-4 flex-grow-1"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-custom mb-0 text-center">
                                        <thead>
                                            <tr>
                                                <th class="text-start">Kota/Kabupaten Asal</th>
                            ...
                            <div class="rounded p-4 d-flex align-items-center justify-content-center text-center"
                                ...
                                @if (count($top_origin) > 0)
                                    <span class="text-dark fw-medium" style="font-size: 1.05rem; line-height:1.5;">
                                        Kab/Kota asal yang menjadi favorit di Jabodetabek untuk melakukan perjalanan (Intra
                                        Jabodetabek) Adalah<br><br>
                                        <span class="highlight text-primary"
                                            style="background-color: #fef08a !important; padding: 10px 15px; font-size: 1.35rem; font-weight: 800; border-radius: 4px; display:inline-block; margin-top: 5px; width: 100%;">{{ strtoupper($top_origin[0]['name']) }}</span>
                                    </span>
                                @endif
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (sankeyData && sankeyData.length > 0 && document.getElementById('sankey-container')) {
