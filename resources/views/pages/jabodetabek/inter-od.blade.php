                ...
                <div class="card-header d-flex align-items-center bg-white"
                    ...
                    <div class="export-dropdown ms-auto">
                        ...
                        <div class="export-menu" id="export-menu-iod01">
                            <button class="export-menu-item" onclick="exportInterOD01CSV()">
                                <i class="bx bx-spreadsheet text-success"></i> CSV (XLSX)
                            </button>
                        </div>
                    </div>
                </div>
                <div class="card-body bg-white" id="section-interod01-content" style="padding: 2.5rem 1.5rem;">
...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            window.exportInterOD01CSV = function() {
                document.querySelectorAll('.export-menu').forEach(m => m.classList.remove('show'));
                const wb = XLSX.utils.book_new();
                const rows = [
                    ['Provinsi Tujuan', 'Jumlah Pergerakan', 'Rank']
                ];
                topDest.forEach((r, i) => {
                    rows.push([r.name, r.total, i + 1]);
                });
