...
@section('content')
    ...
    <div class="row" data-aos="fade-up" data-aos-duration="600">
        <!-- 1. Distribusi Angkutan (Pergerakan - Real) -->
        <div class="col-lg-6 mb-4">
            <div class="card content-card h-100 p-4">
                <div class="chart-title-center">
                    <h5>Distribusi Angkutan (Pergerakan - Real)</h5>
                </div>
                <div class="chart-subtitle-center">
                    [Kode : 1.3.d.1] Berdasarkan jenis angkutan
                </div>
                <div id="chart-pergerakan" style="height: 350px;"></div>
                <div class="custom-legend" id="legend-pergerakan">
                    <!-- Legend generated by JS -->
                </div>
            </div>
        </div>

        <!-- 2. Distribusi Angkutan (Orang - Real) -->
        <div class="col-lg-6 mb-4">
            <div class="card content-card h-100 p-4">
                <div class="chart-title-center">
                ...
                <div class="chart-subtitle-center">
                    [Kode : 1.3.d.2] Berdasarkan jenis angkutan
                </div>
                <div id="chart-orang" style="height: 350px;"></div>
                <div class="custom-legend" id="legend-orang">
                    <!-- Legend generated by JS -->
                </div>
            </div>
        </div>
