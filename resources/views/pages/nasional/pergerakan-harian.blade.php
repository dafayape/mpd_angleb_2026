...
@section('content')
    @component('layout.partials.page-header', ['number' => '04', 'title' => 'Pergerakan Harian Nasional'])
    ...
    @php
        ...
        // Setup Opsels
        $opselsConfig = [
            'XLSMART' => ['name' => 'XLSMART', 'bg_class' => 'bg-navy', 'text_class' => 'text-primary'],
                                        ...
                                        @php
                                            ...
                                            $orderBoxes = [
                                                ...
                                                'XLSMART' => [
                                                    ...
                                                    '#2a3042',
                                                    $data['totals']['XLSMART']['movement'] ?? 0,
                                                ],
                                            ];
                                        @endphp
...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Export Section 01 as XLSX with 3 sheets (XLSMART, IOH, TSEL)
            ...
            window.exportSection04CSV = function(type) {
                ...
                const chartRows = [];
                chartRows.push(['Tanggal', 'XLSMART', 'IOH', 'TSEL']);
                dates.forEach(dateStr => {
