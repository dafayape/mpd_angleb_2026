...
@section('title', 'Kesimpulan Nasional')

@section('content')
    @component('layout.partials.page-header', ['number' => '11', 'title' => 'Kesimpulan Nasional'])
        <ol class="breadcrumb m-0 mb-0">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="#">Kesimpulan</a></li>
            <li class="breadcrumb-item active">Kesimpulan Nasional</li>
        </ol>
    @endcomponent
        ...
        <div class="col-12">
            <div class="card placeholder-page-card shadow-sm">
                <div class="card-body text-center d-flex flex-column align-items-center justify-content-center">
                    ...
                    <h5 class="fw-bold text-dark">Kesimpulan Nasional</h5>
