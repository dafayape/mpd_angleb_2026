...
@section('title', 'Pelabuhan Penyeberangan')

@section('content')
    @component('layout.partials.page-header', ['number' => '14', 'title' => 'Pelabuhan Penyeberangan'])
        <ol class="breadcrumb m-0 mb-0">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="#">Substansi Tambahan</a></li>
            <li class="breadcrumb-item active">Pelabuhan Penyeberangan</li>
        </ol>
    @endcomponent
        ...
        <div class="col-12">
            <div class="card placeholder-page-card shadow-sm">
                <div class="card-body text-center d-flex flex-column align-items-center justify-content-center">
                    ...
                    <h5 class="fw-bold text-dark">Pelabuhan Penyeberangan</h5>
