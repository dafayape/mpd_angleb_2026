        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Upload file .csv dengan separator titik koma (;) sesuai format yang ditentukan.</p>
                    ...
                    <form id="uploadForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="opsel" class="form-label font-weight-bold text-uppercase text-muted" style="font-size: 11px;">OPSEL</label>
                                <select class="form-select" id="opsel" name="opsel" required style="border-radius: 6px;">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="kategori" class="form-label font-weight-bold text-uppercase text-muted" style="font-size: 11px;">TIPE</label>
                                <select class="form-select" id="kategori" name="kategori" required style="border-radius: 6px;">
                        ...
                        <div class="mb-3">
                            <label for="tanggal_data" class="form-label font-weight-bold text-uppercase text-muted" style="font-size: 11px;">Tanggal</label>
                            <input class="form-control" type="date" id="tanggal_data" name="tanggal_data" required style="border-radius: 6px;">
                        </div>

                        <div class="mb-3">
                            <label for="file" class="form-label font-weight-bold text-uppercase text-muted" style="font-size: 11px;">Pilih File CSV</label>
                            <div class="input-group">
                                <label class="input-group-text btn-light" for="file" style="cursor: pointer; background-color: #f1f3f5; border: 1px solid #ced4da;">Browse...</label>
                                <input type="file" class="form-control" id="file" name="file" accept=".csv" required style="display: none;">
                                <input type="text" class="form-control" id="filename-display" placeholder="Belum ada file dipilih." readonly style="background-color: #fff;">
                            </div>
                            <div class="form-text text-muted" style="font-size: 11px;">Format: CSV (separator ;) (maks 1GB)</div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Mengupload Data...</h5>
                </div>
...
<script>
    document.getElementById('file').addEventListener('change', function(e) {
        document.getElementById('filename-display').value = e.target.files[0] ? e.target.files[0].name : "Belum ada file dipilih.";
    });
    ...
    document.getElementById('uploadForm').addEventListener('submit', function(e) {
        ...
        $.ajax({
            ...
            xhr: function() {
                ...
                xhr.upload.addEventListener("progress", function(evt) {
                    if (evt.lengthComputable) {
                        ...
                        statusText.innerText = 'Mengupload ' + bytesToSize(evt.loaded) + ' / ' + bytesToSize(evt.total);
                    }
                }, false);
                return xhr;
            },
            ...
            error: function(xhr) {
                alert('Error Upload: ' + (xhr.responseJSON ? xhr.responseJSON.message : xhr.statusText));
                btn.disabled = false;
                modal.hide();
            }
        });
