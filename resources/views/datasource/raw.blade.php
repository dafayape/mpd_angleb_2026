    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">View Raw Data</h4>
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-select" name="kategori">
                                    ...
                                    <option value="ORANG" {{ request('kategori') == 'ORANG' ? 'selected' : '' }}>ORANG</option>
                                    <option value="PERGERAKAN" {{ request('kategori') == 'PERGERAKAN' ? 'selected' : '' }}>PERGERAKAN</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                ...
                                <select class="form-select" name="is_forecast">
                                    <option value="">Semua</option>
                                    <option value="0" {{ request('is_forecast') === '0' ? 'selected' : '' }}>REAL</option>
                                    <option value="1" {{ request('is_forecast') === '1' ? 'selected' : '' }}>FORECAST</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-primary"><i class="bx bx-filter-alt"></i> Filter</button>
                                <a href="{{ route('datasource.raw-data') }}" class="btn btn-secondary"><i class="bx bx-reset"></i> Reset</a>
                            </div>
                        </div>
                    </form>

                    <div class="table-responsive">
                        <table class="table table-bordered table-hover dt-responsive nowrap w-100 table-sm" style="font-size: 0.75rem;">
